...
<body>
	<div id='contener'>
		...
		<div id='main'>
			...
			<div id='main-right'>
			<c:choose>
					<c:when test="${empty kupione}">
							<p style="margin-left: 100px; font-size: 18pt; font-weight: bold;">Nie kupiłeś jeszcze żadnego produktu </p>  	
					</c:when>
  				<c:otherwise>
				<c:forEach items="${kupione}" var="element" varStatus="status"> 
