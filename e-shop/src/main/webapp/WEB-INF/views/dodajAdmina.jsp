					...
					<tr>
						...
						<td>
							<div style="border-left: 1px solid black; padding-left: 10px;">
								<a href="<c:url value='/panel/' />" style="font-weight:bold; font-size: 16px;;text-decoration: none; border: none; color: black;">MOJE KONTO</a>
							</div>
						</td>
						<td>
							<div style="border-left: 1px solid black; padding-left: 10px; ">
		...
		<sf:form method="POST" action="/jez/panel/dodajAdmina">
			...
			<tr>
				<td cols="2" align='center'>
					<input class="sub" style='margin-left: 50px;' type="submit" value="Dodaj admina" /> 
				</td>
			</tr>
			</table>
			</fieldset>
