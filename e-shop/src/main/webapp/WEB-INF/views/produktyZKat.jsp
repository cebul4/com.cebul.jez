		...
		<div id='main'>
			...
			<c:choose>
					<c:when test="${empty sprzedane}">
							<p style="margin-left: 100px; font-size: 18pt; font-weight: bold;">Brak przedmiotów w tej podkategorii </p>  	
					</c:when>
  				<c:otherwise>
						...
						<div  class="divProd" style=" width: 760px; height: 70px;border-bottom: 1px solid #DFDFDF; ">
							...
							<c:choose>
								...
								<div style="width: 830px;">
									...
									<div>
										<a href="${pageContext.request.contextPath}/produkty/edytuj/${element.id}/">
											<img style="width: 25px; margin-top: 15px;" src="<c:url value='/resources/images/edit.png' />" />
										</a>
										<a href="${pageContext.request.contextPath}/produkty/usun/${element.id}/">
											<img style="width: 25px; " src="<c:url value='/resources/images/error.png' />" />
										</a>
									</div>
								</div>
						</div>
